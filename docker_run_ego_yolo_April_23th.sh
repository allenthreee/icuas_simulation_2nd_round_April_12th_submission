...
CONTAINER_NAME=icuas_simulation_ego_yolo_April_23th
...
full_container_name="icuas_simulation_ego_yolo_April_23th"
...
docker run \
  ...
  allenthreee/icuas_simulation_ego_yolo:3rd_April_23th \
  /bin/bash
